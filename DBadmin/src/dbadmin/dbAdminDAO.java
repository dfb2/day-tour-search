...
public class dbAdminDAO implements DAO {
    ...
    private static final String TOURS_ERLING_LAPTOP = "C:\\Users\\ellio\\Documents\\hi\\v19\\hbv\\dts\\DBadmin\\DatabaseValues\\Tours.txt";
    private static final String TOUROPERATORS_ERLING_LAPTOP = "C:\\Users\\ellio\\Documents\\hi\\v19\\hbv\\dts\\DBadmin\\DatabaseValues\\TourOperators.txt";
    ...
    private static void ReadAndInsertTourOperators(Connection c) 
         ...
         File file = new File(TOUROPERATORS_ERLING_LAPTOP);
    ...
    // Hægt að bæta boolean inntaki á fallið og sleppa því að eyða eftir að operators geta búið til sína eigin tours
         ...
         // má breyta í relative path ef einhvern tímann þörf
         File file = new File(TOURS_ERLING_LAPTOP);
         Scanner sc = new Scanner(file);
